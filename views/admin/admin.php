                    ...
                    <div class="table-responsive">
                        <table class="table table-hover">
                            ...
                            <?php foreach ($result as $res): ?>
                                <tr>
                                    <!--th scope="row">1</th-->
                                    <td><a href="/task/overview/<?php echo $res['id']; ?>"><img
                                                    class="img_sm img-rounded"
                                    ...
                                    <td>
                                        <a class="btn btn-default btn-sm"
                                           href="/task/overview/<?php echo $res['id']; ?>" role="button">Просмотр</a>
                                        <a class="btn btn-warning btn-sm" href="/task/edit/<?php echo $res['id']; ?>"
                                           role="button">Изменить</a><br><br>
